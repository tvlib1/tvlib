...
// This script has been created by Mega Deportes (if you want to use this script check Mega Deportes Creative Common license)
...
function guardaHorario() {
	...
	*/
    ...
    //Se guarda el huso local en una variable global.
	...
	*/
    ...
    for (i = 0; i < elements.length; i++) {
        if (elements[i].className == 't') {
            ...
            //<!-- Cambiar s贸lo aqu铆 para horario de verano (120) e invierno (60)
            if (formato == "AMPM") {
